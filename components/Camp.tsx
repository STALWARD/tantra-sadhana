    ...
    <section className="relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20 max-w-7xl mx-auto">
      <div className="hide-scrollbar flex h-85 w-full items-start justify-start gap-8 overflow-x-auto lg:h-100 xl:h-160">
        <Image
          ...
          height={580}
          loading="lazy"
          className="h-full w-auto object-cover object-center shrink-0 rounded-xl"
        />
        <Image
          src="/img-2.webp"
          alt="yoga meditation"
      ...
      <div className="flex justify-end mt-2 px-4 lg:-mt-60 lg:mr-6">
        <div className="bg-yellow-200 p-12 lg:max-w-125 xl:max-w-183.5 xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">

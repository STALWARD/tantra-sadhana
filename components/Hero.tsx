...
const Hero = () => {
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-5 md:gap-28 lg:py-10 lg:flex-row relative">
      ...
      {/* 1. Optimized Video: Added poster for LCP and aria-hidden for accessibility */}
      <div className="flexCenter max-container absolute inset-0 -z-10 overflow-hidden" aria-hidden="true">
        <video 
          loop 
          muted 
          autoPlay 
          playsInline 
          preload="metadata"
          poster="/hero-video-placeholder.jpg" // High-quality compressed frame of the video

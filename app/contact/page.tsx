  ...
  return (
    <div className="flex flex-col w-11/12 content-center m-auto mt-10">
      ...
      <div className="flex mt-5">
        <iframe width="100%" height="500" scrolling="no" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Saarthi%20Welfare%20Foundation%20Trust%20Tamboo%20Resort+(My%20Business%20Name)&amp;t=&amp;z=17&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/">gps trackers</a></iframe>
      </div>

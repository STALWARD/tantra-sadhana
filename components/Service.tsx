    ...
    render() {
        ...
        return (
			...
			<div className=" relative flex  flexCenter w-full mt-10" >
				...
				<p className="absolute text-xl text-center text-gold justify-center font-simple mt-80 p-20 pageHeader">We offer spiritual guidance and education to those seeking to deepen their understanding of Tantric teachings. </p>
			</div>

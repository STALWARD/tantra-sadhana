    ...
    render() {
        ...
        return (
			...
			<div className=" relative flex  flexCenter w-full mt-10" >
				...
				<p className="absolute text-xl text-center text-black justify-center font-semibold mt-80 p-20 pageHeader"> Through blog posts, videos and other resources, we provide an accessible platform for individuals to learn about Tantra and its various practices as well as for performing Tantric Rituals. </p>
			</div>
